...
<plist version="1.0">
<dict>
	<key>Xcode.SourceCodeLanguage.Msx</key>
	<dict>
		<key>languageSpecification</key>
		<string>xcode.lang.msx</string>
		<key>fileDataType</key>
		<array>
			<dict>
				<key>identifier</key>
				<string>com.apple.xcode.msx-source</string>
			</dict>
		</array>
		<key>id</key>
		<string>Xcode.SourceCodeLanguage.Msx</string>
		<key>point</key>
		...
		<key>name</key>
		<string>Lua Language With CC and MobGui API</string>
	</dict>
</dict>
</plist>
EOF
...
#
cp "$SCRIPT_PATH/Msx.xclangspec" "$DVTFOUNDATION_PATH"
